...
$cmd = "export MSYSTEM=UCRT64; export PATH=/ucrt64/bin:\$PATH; export ARCHIVE_R_BUILD_NO_ISOLATION=1; export ARCHIVE_R_SKIP_TWINE_CHECK=1; cd $repoPathMsys && ./build.sh --rebuild-all"
switch ($PackageMode) {
  'core'   { }
